...
echo "=== 609 VilORM Overhead Bench ==="
...
# Raw sqlx — list items
assert_http_status "$BASE/api/bench/raw/items" 200 "raw list items"

# Raw sqlx — count
assert_http_status "$BASE/api/bench/raw/count" 200 "raw count"

# Raw sqlx — columns
assert_http_status "$BASE/api/bench/raw/cols" 200 "raw cols"

# VilORM — list items
assert_http_status "$BASE/api/bench/orm/items" 200 "orm list items"

# VilORM — count
assert_http_status "$BASE/api/bench/orm/count" 200 "orm count"

# VilORM — columns
assert_http_status "$BASE/api/bench/orm/cols" 200 "orm cols"
