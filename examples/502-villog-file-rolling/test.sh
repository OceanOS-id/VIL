...
echo "=== 502 VilLog File Rolling ==="
echo -e "  ${YELLOW}SKIP${NC} CLI binary (RUN type) — not HTTP testable"
echo -e "  ${DIM}Run manually: cargo run --example 502-villog-file-rolling${NC}"
