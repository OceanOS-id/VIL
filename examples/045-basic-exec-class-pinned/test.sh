...
echo "=== 045-basic-exec-class-pinned ==="

PORT=${PORT:-8080}
BASE="http://127.0.0.1:${PORT}"

# Test: POST /api/sensor/sensor/process
PROCESS_PAYLOAD=$(cat "$SCRIPT_DIR/payloads/process.json")
assert_http_status_post "${BASE}/api/sensor/sensor/process" "$PROCESS_PAYLOAD" "200" \
    "POST /api/sensor/sensor/process returns HTTP 200"

# Test: GET /api/sensor/sensor/stats
assert_http_status "${BASE}/api/sensor/sensor/stats" "200" \
    "GET /api/sensor/sensor/stats returns HTTP 200"
