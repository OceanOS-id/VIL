#!/usr/bin/env tsx
// 607-db-vilorm-multitenant — TypeScript SDK equivalent
// Compile: vil compile --from typescript --input 607-db-vilorm-multitenant.ts --release

import { VilPipeline, VilServer, ServiceProcess } from "vil-sdk";

const server = new VilServer("vilorm-multitenant", 8087);
const saas = new ServiceProcess("saas");
