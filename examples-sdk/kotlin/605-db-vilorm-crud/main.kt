// 605-db-vilorm-crud — Kotlin SDK equivalent
// Compile: vil compile --from kotlin --input 605-db-vilorm-crud/main.kt --release

fun main() {
    val server = VilServer("vilorm-showcase", 8080)
    val blog = ServiceProcess("blog")
